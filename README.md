...
| Project | Description | Tools |
|---|---|---|
| [Recipe Rating Prediction](https://github.com/saib-poorna/Recipes_and_Reviews_Data_Model_Building) ([live page](https://saib-poorna.github.io/Recipes_and_Reviews_Data_Model_Building/)) | Cleaned and merged food.com's 83,782-recipe and 731,927-review datasets, then tested whether recipe rating depends on ingredient count (permutation test, p=0.38 — no significant difference found). Built on that analysis to tune a Random Forest regression pipeline predicting recipe ratings, and validated model fairness across subgroups with a separate permutation test (p=0.007). Exploratory analysis in [Recipes_Reviews_Data_Analysis](https://github.com/saib-poorna/Recipes_Reviews_Data_Analysis), modeling in this repo. | Python, pandas, scikit-learn |
| [Global Energy Consumption Viz](https://github.com/MarlonPlease/DSC106-Project-3) ([live page](https://marlonplease.github.io/DSC106-Project-3/)) | Interactive D3.js/Svelte chart of the top energy-per-capita consumers, 1900–2022, with year selection and hover detail. | D3.js, Svelte, JavaScript |
...
| Project | Description | Tools |
|---|---|---|
| [RGB Image Processing Library & k-NN Classifier](https://github.com/saib-poorna/RGB-Image-Processing-kNN-Classifier) | Built an object-oriented image library (grayscale, chroma-key, sticker compositing) and a from-scratch k-NN image classifier. | Python, NumPy, PIL |
